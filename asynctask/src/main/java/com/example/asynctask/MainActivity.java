...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static class MyTaskParams {
        ...
        MyTaskParams(String inputname,int input) {
            this.inputname = inputname;
            this.sleepInSeconds = input;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
         ...
         /*       // This is a inline implementation where we directly access the method
                ...
                String inputname = String.valueOf(inputName.getText().toString());




                MyTaskParams params = new MyTaskParams(inputname,sleepInSeconds);
                AsyncTaskWithParamsResult myTask = new AsyncTaskWithParamsResult();
...
/*            // Example of inline Handler
    ...
    private class AsyncTaskWithParamsResult extends AsyncTask<MyTaskParams, Void, String> {
        ...
        protected String doInBackground(MyTaskParams... params) {
            ...
            String NAME = params[0].inputname;
            int sleepInSeconds = params[0].sleepInSeconds*1000;
...
//            int n = rand;
            ...
            String result = String.format(Locale.getDefault(), NAME + "'s Random number is %d ", rand);
            return result;
        }
